...
数量	3	3
内存	16G	8G
CPU	CPU e5-2620及以上	CPU e5-2620及以上
网卡	千兆网口2个、万兆网口2个	千兆网口2个、万兆网口2个
硬盘	独立操作系统硬盘	独立操作系统硬盘，独立数据硬盘

|主机类型 |数量 |CPU |内存 |网卡 |硬盘 |
| :--- | :--- | :--- | :--- | :--- | :--- |
|管理服务主机 | 1  |CPU e5-2620及以上|16G|千兆网口2个、万兆网口2个 |独立操作系统硬盘|
|数据库服务主机 | 1  |CPU e5-2620及以上|16G|千兆网口2个、万兆网口2个 |独立操作系统硬盘|
